...
namespace Sofbeauty_API_MiguelCR.Controllers
{
    ...
    public class ShoppingCartsController : ControllerBase
    {
        ...
        public ShoppingCartsController(SofbeautyContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<ShoppingCart>> PostShoppingCart(ShoppingCart shoppingCart)
        {
            ...
            return CreatedAtAction("GetShoppingCart", new { id = shoppingCart.CartsId }, shoppingCart);
        }
        ...
        {
            return _context.ShoppingCarts.Any(e => e.CartsId == id);
        }
    }
}
