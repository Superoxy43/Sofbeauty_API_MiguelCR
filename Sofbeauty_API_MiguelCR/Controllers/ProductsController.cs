...
namespace Sofbeauty_API_MiguelCR.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(SofbeautyContext context)
        {
            _context = context;
        }
        ...
        [HttpPost("AddProductFromApp")]
        public async Task<ActionResult<ProductDTO>> AddProductFromApp(ProductDTO product)
        {
            ...
            Product NuevoUsuarioNativo = new()
            {
                ProductsName = product.PNombre,
            ...
            _context.Products.Add(NuevoUsuarioNativo);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetProduct", new { id = NuevoUsuarioNativo.ProductsId }, NuevoUsuarioNativo);
        }
